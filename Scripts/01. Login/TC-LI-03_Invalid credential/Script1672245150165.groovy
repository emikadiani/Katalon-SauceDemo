...
WebUI.setText(findTestObject('01. Login/Page_Swag Labs/input_user-name'), 'standard_users')

WebUI.setText(findTestObject('01. Login/Page_Swag Labs/input_password'), 'secret_saus')
